namespace ParvazPardaz.DataAccess.Migrations
{
    ...
    public partial class selectedFlight1 : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("Book.SelectedFlights", "BaggageAmount", c => c.String(maxLength: 20));
        ...
        public override void Down()
        {
            ...
            AlterColumn("Book.SelectedFlights", "BaggageAmount", c => c.String());
