...
namespace ParvazPardaz.Payment.SamanBankReferencePayment
{
    using System;
    ...
    public partial class PaymentIFBinding : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        {
            this.Url = global::ParvazPardaz.Payment.Properties.Settings.Default.ParvazPardaz_Payment_SamanBankInitPayment_PaymentIFBinding;
