...
namespace ParvazPardaz.Service.Contract.Users
{
    public interface IApplicationSignInManager : IDisposable
    {
        ...
        /// <summary>
        /// add login user to log
        /// </summary>
        /// <param name="model"></param>
        void LogLogin(User model,HttpBrowserCapabilitiesBase request);
        void LogUnSuccessLogin(LoginViewModel model, HttpBrowserCapabilitiesBase request);
    }
}
