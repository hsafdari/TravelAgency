...
namespace ParvazPardaz.Service.Contract.Users
{
    ...
    {
        #region Microsoft.AspNet.Identity.UserManager - متدهای مربوط به کلاس
        ...
        #region Our new custom methods
        bool CheckIsUserNotActive(int id);
        bool CheckIsUserNotActive(string userName);
        bool CheckIsUserNotActiveByEmail(string email);
        Task<bool> HasPassword(int userId);
        Task<bool> HasPhoneNumber(int userId);
        Task RemoveAll();
        Task<List<User>> GetAllUsersAsync();
        bool Any();
        IList<User> GetUsersWithRoleIds(params int[] ids);
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        Task<bool> IsSystemUser(int id);
        long Count();
        string GetIpAddress();
        /// <summary>
        /// مقدار دهی اولیه جدول کاربران
        /// </summary>
        void SeedDatabase();
        /// <summary>
        /// واکشی کاربران برای نمایش در گرید
        /// </summary>
        /// <returns></returns>
        IQueryable<GridUserViewModel> GetViewModelForGrid(UserProfileType profileType);
        /// <summary>
        /// رجیستر کاربر
        /// </summary>
        ...
        /// <param name="viewModel"></param>
        /// <returns></returns>
        Task<IdentityResult> CreateUserAsync(AddUserViewModel viewModel);
        /// <summary>
        /// رجیستر کاربر سمت ادمین
        /// </summary>
        /// <param name="viewModel"></param>
        /// <returns></returns>
        Task<IdentityResult> SignupAdminAsync(AddUserUserProfileViewModel viewModel);
        /// <summary>
        /// پیدا کردن این کاربر و تبدیل آن به ویومدل ویرایش کاربر
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        Task<EditUserViewModel> GetUserViewModelAsync(int id);
        /// <summary>
        /// ویرایش کاربر
        /// </summary>
        /// <param name="viewModel"></param>
        /// <returns></returns>
        Task<EditUserViewModel> EditUserAsync(EditUserViewModel viewModel);
        /// <summary>
        /// حذف منطقی کاربر
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        Task<User> DeleteLogicallyAsync(int id);
        /// <summary>
        /// پیدا کردن این کاربر و تبدیل آن به ویومدل پروفایل کاربر
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        Task<MyProfileViewModel> GetProfileViewModel(int id);

        /// <summary>
        /// ویرایش پروفایل کاربر در پنل ادمین
        /// </summary>
        /// <param name="viewModel"></param>
        /// <returns></returns>
        Task<MyProfileViewModel> EditProfileAsync(MyProfileViewModel viewModel); 

        /// <summary>
        /// ویرایش پروفایل کاربر در پنل کاربر
        /// </summary>
        /// <param name="viewModel"></param>
        /// <returns></returns>
        Task<MyProfileViewModel> EditUserProfileAsync(MyProfileViewModel viewModel);

        int ChangeUserStatus(int Id, ParvazPardaz.Model.Enum.StatusUser StatusUser);

        #region GetWriterDDL
        /// <summary>
        /// واکشی نویسندگان
        /// </summary>
        /// <returns>دراپ داون</returns>
        SelectList GetBlogWriterDDL(); 
        #endregion
