...
{
    public class AddContentViewModel : BaseViewModelId
    {
        #region Constructor
        ...
        //[Required(ErrorMessageResourceName = "Required", ErrorMessageResourceType = typeof(ParvazPardaz.Resource.Validation.ValidationMessages))]
        //[Remote("IsUniqueUrl", "Content", AdditionalFields = "Id", ErrorMessageResourceName = "Duplicate", ErrorMessageResourceType = typeof(ParvazPardaz.Resource.Validation.ValidationMessages))]
