...
{
    public class AddUserUserProfileViewModel : BaseViewModelId
    {
        #region ctor
        public AddUserUserProfileViewModel()
        {
        ...
        #region Roles
        public virtual List<Role> _roles { get; set; }
        [Required(AllowEmptyStrings=false,ErrorMessage="حداقل یک نقش را انتخاب نمایید")]
        public List<int> _selectedRoles { get; set; }    
        #endregion
        ...
        [EmailRemote("IsUniqueEmail", "MyAccount", "Customer", AdditionalFields = "Id", ErrorMessageResourceName = "DuplicateEmail", ErrorMessageResourceType = typeof(ParvazPardaz.Resource.Validation.ValidationMessages))]
        ...
        [Display(Name = "Shasi", ResourceType = typeof(ParvazPardaz.Resource.EShop.EShopResource))]
