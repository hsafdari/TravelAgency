...
namespace ParvazPardaz.Web.AutoMapperProfile
{
    public class CurrencyProfile : Profile
    {
        ...
        {
            CreateMap<Currency, EditCurrencyViewModel>().IgnoreAllNonExisting();
            CreateMap<Currency, GridCurrencyViewModel>().ForMember(x => x.CreatorDateTime, m => m.MapFrom(model => (model.CreatorDateTime.HasValue) ? model.CreatorDateTime : null))
