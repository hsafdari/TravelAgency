...
{
    public class SupportConfig : Profile
    {
        protected override void Configure()
        {
            CreateMap<Support, AddSupportViewModel>().IgnoreAllNonExisting();
            CreateMap<AddSupportViewModel, Support>().IgnoreAllNonExisting();

            CreateMap<EditSupportViewModel, Support>().IgnoreAllNonExisting();
            CreateMap<Support, EditSupportViewModel>().IgnoreAllNonExisting();

            CreateMap<Support, GridSupportViewModel>()
