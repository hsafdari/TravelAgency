...
RoxyUtils.LoadLang = function(){
  ...
  if(RoxyFilemanConf.LANG && RoxyFilemanConf.LANG.toLowerCase() == 'auto'){
    if(RoxyUtils.GetUrlParam('langCode')){
      langUrl = '/Areas/Admin/scripts/RoxyFileManager/lang/' + RoxyUtils.GetUrlParam('langCode').substr(0, 2).toLowerCase() + '.json';
    }
    else {
      var language = window.navigator.userLanguage || window.navigator.language;
      langUrl = '/Areas/Admin/scripts/RoxyFileManager/lang/' + language.substr(0, 2) + '.json';
    }
    ...
    if(RoxyFilemanConf.LANG){
      langUrl = '/Areas/Admin/scripts/RoxyFileManager/lang/' + RoxyFilemanConf.LANG.substr(0, 2).toLowerCase() + '.json';
      if(!RoxyUtils.FileExists(langUrl))
        langUrl = '';
      }
  }
  if(!langUrl)
    langUrl = '/Areas/Admin/scripts/RoxyFileManager/lang/en.json';
